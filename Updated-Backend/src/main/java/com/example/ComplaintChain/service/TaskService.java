...
public class TaskService {
    ...
    public List<Task> getTasksByComplaint(Long complaintId) {
        return taskRepository.findByComplaintId(complaintId);
    }

    // ✅ Add this method for updating tasks
    public Task updateTask(Long id, Task taskDetails) {
        Task task = taskRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Task not found"));
        task.setComplaintId(taskDetails.getComplaintId());
        task.setAuthorityId(taskDetails.getAuthorityId());
        task.setDeadline(taskDetails.getDeadline());

        return taskRepository.save(task);
    }

    public void deleteTasksByComplaintId(Long complaintId) {
        taskRepository.deleteByComplaintId(complaintId);
    }
